...
# Objects are cuboids, plots the cuboids in 3d grid, created all rays that we need based on 2d plot
large = 3
medium = 2
small = 1
...
segment1 = objects[1].obstructing_segments
# for cuboid in objects:
#     for segment in cuboid.obstructing_segments:
#         if segment.direction().dx() != 0 and segment.direction().dy() == 0:
#             print(f'{segment} is horizontal')
#         else:
#             print(f'{segment} is vertical')
list_of_rays = []
for cuboid in objects:
    for segment in cuboid.obstructing_segments:
        ...
        for point in ray_points:
            ...
            list_of_rays.append(Ray(camera, direction))
