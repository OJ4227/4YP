...
# Changed create_rays_for_3d to take a segment and associated cuboid as input, so we can then re-use the function inside
# the multiple_ray_cast function. Now hopefully sees all objects correctly
