...
# Fixed issue where the limits of the faces were too exact so rays that were intersecting with a face weren't being
# detected because they were 1e-10 off the correct limit
